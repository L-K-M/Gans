#!/usr/bin/env bash
# Builds Gans.app from the command line and reveals it in Finder on success.
...
set -euo pipefail
export BUILD_APP_NAME="Gans"
export BUILD_KIND="xcode"
export BUILD_XCODE_PROJECT="Gans.xcodeproj"
export BUILD_XCODE_SCHEME="Gans"
